...
public:
    ...
    QByteArray textMessage(QString message, QString receiver, QString sender); // Добавлен параметр sender
    ...
    const QString &sender() const; // Добавлен геттер для sender
...
private:
    ...
    QString _receiver;
    QString _sender; // Добавлен член данных для sender
};
